...
package edu.oakland.portlet.mvc;
...
public class ThemeNameViewSelectorImpl implements IViewSelector {
	...
	for (String theme : mobileThemes) {
		...
		logger.debug(
		    "Theme name " + themeName + " matches configured list of mobile themes");
		return true;
	    }
	}

	logger.debug(
	    "No match found for theme name " + themeName + ", assuming desktop environment");
	return false;
    }
}
